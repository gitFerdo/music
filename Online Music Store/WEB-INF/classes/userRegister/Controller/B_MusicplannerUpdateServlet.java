...
public class B_MusicplannerUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = B_MusicplannerDButil.UpdateMovies(emp_id, emp_name, emp_cnt, emp_email, emp_jroll);
		
		if(isTrue == true) {
			
			List<B_Musicplanner> movDetails = B_MusicplannerDButil.getMovieDetails(emp_id);
