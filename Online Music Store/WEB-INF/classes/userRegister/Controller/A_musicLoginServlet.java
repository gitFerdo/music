...
import userRegister.Deo.A_musicLoginDButil;
import userRegister.Model.user;

@WebServlet("/LoginServlet")
public class A_musicLoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = A_musicLoginDButil.validate(username, password);
		
		if(isTrue == true) {
			List<user> usDetails = A_musicLoginDButil.getUser(username);
