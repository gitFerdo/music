...
import userRegister.Deo.A_musicEditprofile_DButil;

@WebServlet("/Dashboard_loginServlet")
public class A_musicRetrieveServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<A_musicUploader> userDetails = A_musicEditprofile_DButil.Validate(User_N,Pass_w);
