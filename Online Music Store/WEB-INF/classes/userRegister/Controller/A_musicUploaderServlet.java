...
import userRegister.Deo.A_musicUploaderDeo;
import userRegister.Model.A_musicUploader;

@WebServlet("/eventUploaderServlet")
public class A_musicUploaderServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	private A_musicUploaderDeo upldDao = new A_musicUploaderDeo();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        A_musicUploader Upld = new A_musicUploader(); 
