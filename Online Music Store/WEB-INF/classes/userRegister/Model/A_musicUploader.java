...
public class A_musicUploader {
	...
	public A_musicUploader() {
		//super();
	}
	public A_musicUploader(int u_id, String u_firstNamr, String u_lastName, String u_username, String u_password,
