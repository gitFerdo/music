			  ...
			  <div class='right-container'>
			   <form action="UploadDbServlet" method="post"> 
			    <header>
			      ...
			      <div class='set'>
			        <div class='pets-name'>
			          <label for='pets-name'><b>Music Name:</b></label>
			          <input id='pets-name' placeholder="Nena" type='text' name="ename" required autocomplete="off">
			        </div>
			        <div class='pets-name'>
			          <label for='pets-upload'><b>Music Upload Date:</b></label>
			      ...
			      <div class='set'>
			        <div class='pets-name'>
			          <label for='pets-name'><b>Owner Name:</b></label>
			          <input id='pets-name' placeholder="Thiwanka Dilshan" type='text' name="eorgname" required autocomplete="off">
			        </div>
			        <div class='pets-name'>
			          <label for='pets-upload'><b>Release Date:</b></label>
			    ...
			    <footer>
			      <div class='get'>
			        <button id='next' onclick="myFunction()">UPLOAD MUSIC</button>
			      </div>
			    </footer>
			   </form> 
