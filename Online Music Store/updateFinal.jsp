	...
	<div id="shell">
			  ...
			  <div class="form2">
				  <div class="form">
				      ...
				      <ul class="tab-group">
				        <li class="tab active"><a href="#signup">Update Details</a></li>
				      </ul>
				      ...
				      <div class="tab-content">
				        <div id="signup">
				          ...
				          <div class="field-wrap">
				            <label>
				              Uploader ID<span class="req">*</span>
				            </label>
				          ...
				          <div class="top-row">
				            <div class="field-wrap">
				              <label>
				                Uploader Name<span class="req">*</span>
				              </label>
				            ...
				            <div class="field-wrap">
				              <label>
				                Music Upload Date<span class="req">*</span>
				              </label>
				          ...
				          <div class="top-row">
				            <div class="field-wrap">
				              <label>
				                Music Code<span class="req">*</span>
				              </label>
				            ...
				            <div class="field-wrap">
				              <label>
				                Music Category<span class="req">*</span>
				              </label>
				          ...
				          <div class="top-row">
				            <div class="field-wrap">
				              <label>
				                Owner's Name<span class="req">*</span>
				              </label>
				            ...
				            <div class="field-wrap">
				              <label>
				                 Released Date<span class="req">*</span>
				              </label>
