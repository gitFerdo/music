...
<body translate="no">
	<div id="shell">
			  <div id="header1">
			    ...
			    <div id="navigation" class="tab-group">
			      <ul>
			        <li><a href="index.jsp">HOME</a></li>
			        <li><a href="#">NEWS</a></li>
			        <li class="tab active" autofocus><a href="#signup">Registration</a></li>
			  ...
			  <div class="form">
			      ...
			      <div class="tab-content">
			        <div id="signup">   
			          ...
			          <button type="submit" class="button button-block" style= "border-radius: 12px;"/>CREATE ACCOUNT</button>
			        ...
			        <div id="login">   
			          ...
			          <button class="button button-block" style= "border-radius: 20px;"/>Sign In</button>
